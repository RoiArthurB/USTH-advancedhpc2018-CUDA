...
The idea in this labwork was to reduce one block (1024 threads), stock the final reduction in a shared memory and recall the kernel with the new array to reduce in parameter.

To do so, the implementation in the host is a loop with the kernel inside like so :

\begin{lstlisting}[style=CStyle]
	do {
		// Call kernel reduction
        ...
        cudaMemcpy(temp, devHisto, dimGridR * sizeof(int), cudaMemcpyHostToDevice);
